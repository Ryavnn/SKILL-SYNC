...
const Button = React.forwardRef(({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
  ...
  const variants = {
    ...
    destructive: "bg-[var(--destructive)] text-[var(--primary-foreground)] shadow-sm hover:opacity-90",
    outline: "border border-[var(--border)] bg-[var(--background)] shadow-sm hover:bg-[var(--muted)] hover:text-[var(--accent-foreground)]",
